        ...
        <div className="mb-3">
          <div className="flex rounded-md shadow-sm">
            <input
              ...
              className="flex-1 min-w-0 block w-full px-3 py-3 sm:py-2 rounded-none rounded-l-md border border-gray-300 focus:ring-blue-500 focus:border-blue-500 text-base sm:text-sm"
            />
            <button
              type="button"
              onClick={handleAddCustomTag}
              disabled={!customTag.trim()}
              className="inline-flex items-center px-3 py-3 sm:py-2 border border-l-0 border-gray-300 rounded-r-md bg-gray-50 text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 disabled:opacity-50 disabled:cursor-not-allowed text-base sm:text-sm touch-target"
            >
              Add
            </button>
          </div>
            ...
            {displayTags.map((tag) => {
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center px-2.5 py-2 sm:py-1.5 rounded-md text-sm sm:text-xs font-medium transition-colors touch-target ${
                    isSelected
